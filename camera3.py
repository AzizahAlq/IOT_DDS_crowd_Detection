...
class CameraPublisher:
    ...
    def publish_frames(self):
        while self.cap.isOpened():
            ...
            # Create and publish the VideoFrame message with camera_id
            message = VideoFrame(camera_id=self.camera_id, frame_data=frame_base64)
            self.writer.write(message)

            print(f"Published a frame from {self.camera_id}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--camera_id", type=str, default="camera_3", help="Camera ID (default: camera_1)")
